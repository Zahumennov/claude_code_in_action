            ...
            <ResizablePanel defaultSize={65}>
              <div className="h-full flex flex-col bg-white">
                ...
                <div className="h-14 border-b border-neutral-200/60 px-6 flex items-center justify-between bg-neutral-50/50">
                  <div className="inline-flex items-center gap-0.5 bg-white/60 border border-neutral-200/60 rounded-lg p-0.5 h-9 shadow-sm">
                    <button
                      onClick={() => setActiveView("preview")}
                      className={cn(
                        "inline-flex items-center justify-center rounded-md border border-transparent px-4 py-1.5 text-sm font-medium transition-all cursor-pointer",
                        activeView === "preview"
